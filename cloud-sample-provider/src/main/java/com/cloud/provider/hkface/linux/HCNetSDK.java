...
package com.cloud.provider.hkface.linux;
...
//        public HCNetSDK.NET_VCA_BLACKLIST_INFO struBlackListInfo; //黑名单基本信息
...
//NET_DVR_SetDVRMessage的扩展
 ...
 /** NVR 通道相关的接口 **/
// boolean NET_DVR_GetDVRConfig(NativeLong lUserID,int dwCommand,NativeLong lChannel,NET_DVR_GET_IPPARACFG_V40 lpOutBuffer,int dwOutBufferSize);
...
interface PlayCtrl extends Callback
{
