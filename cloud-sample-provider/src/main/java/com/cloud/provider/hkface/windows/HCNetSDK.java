...
package com.cloud.provider.hkface.windows;

import com.cloud.provider.utils.LibraryPathUtil;
import com.sun.jna.*;
...
//            HCNetSDK.class);
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(LibraryPathUtil.DLL_PATH + "\\HCNetSDK",
            HCNetSDK.class);
    /***宏定义***/
    //常量
